...
from .providers.system.powershell import PowerShellSystemProvider
from .providers.system.wmic import WmicSystemProvider
from .providers.network.powershell import PowerShellNetworkProvider
...
class WindowsBackend(ISystemAdapter, INetworkAdapter, IFirewallAdapter, INtpAdapter):
    ...
    def __init__(self, config: Optional[BackendConfig] = None):
        ...
        # lacks one backend can still run commands for the other concerns, and only
        # the unavailable concern fails.
        self._candidates = {
